...
export const ACHIEVEMENT_VISUAL_KEY = {
  IN_GAME: "in_game",
  TRIUMPHATOR: "triumphator",
  PLAYER_PATH: "player_path",
  ITM: "itm",
  ...
  MARCO_REUS: "marco_reus",
} as const;
export type AchievementVisualKey =
  (typeof ACHIEVEMENT_VISUAL_KEY)[keyof typeof ACHIEVEMENT_VISUAL_KEY];

export const ACHIEVEMENT_FRAME_KEY = {
  BRONZE: "bronze",
  SILVER: "silver",
  GOLD: "gold",
  PLATINUM: "platinum",
} as const;
export type AchievementFrameKey =
  (typeof ACHIEVEMENT_FRAME_KEY)[keyof typeof ACHIEVEMENT_FRAME_KEY];
export type AchievementAssetKey = AchievementVisualKey | AchievementFrameKey;

export const ACHIEVEMENT_FAMILIES = {
  [ACHIEVEMENT_FAMILY.IN_GAME]: {
    name: "В игре",
...
export const ACHIEVEMENTS_CATALOG = [
  // --- Participation (tournaments_played) ---------------------------------
  {
    ...
    family: ACHIEVEMENT_FAMILY.IN_GAME,
    hidden: false,
    sortOrder: 0,
  },
  {
  ...
  // --- Competition (tournaments_won) ---------------------------------------
  {
    ...
    target: 1,
    tier: ACHIEVEMENT_TIER.BRONZE,
    family: ACHIEVEMENT_FAMILY.TRIUMPHATOR,
    hidden: false,
    sortOrder: 4,
  },
  {
  ...
  // --- Rating (rating_points) ----------------------------------------------
  {
    ...
    target: 100,
    tier: ACHIEVEMENT_TIER.BRONZE,
    family: ACHIEVEMENT_FAMILY.PLAYER_PATH,
    hidden: false,
    sortOrder: 8,
  },
  {
  ...
  {
    id: "pro_2500_rating",
    code: "pro_2500_rating",
    name: "Профи",
    description: "Набрать 2500 очков",
    category: ACHIEVEMENT_CATEGORY.RATING,
    icon: ACHIEVEMENT_ICON.AWARD,
    type: ACHIEVEMENT_TYPE.AUTOMATIC,
    source: ACHIEVEMENT_SOURCE.RESULTS,
  ...
  {
    id: "club_legend_10000_rating",
    code: "club_legend_10000_rating",
    name: "Легенда клуба",
  ...
  // --- Referral (referrals) -------------------------------------------------
  {
    ...
    target: 1,
    tier: ACHIEVEMENT_TIER.BRONZE,
    family: ACHIEVEMENT_FAMILY.COMMUNITY,
    hidden: false,
    sortOrder: 18,
  },
  {
  ...
  // rows existed for the old codes in production (checked before removal).
  {
    ...
    target: 3,
    tier: ACHIEVEMENT_TIER.BRONZE,
    family: ACHIEVEMENT_FAMILY.STREAK,
    hidden: false,
    sortOrder: 26,
  },
  {
  ...
  },
  {
    ...
    type: ACHIEVEMENT_TYPE.AUTOMATIC,
    source: ACHIEVEMENT_SOURCE.AUTOMATIC,
    visualKey: ACHIEVEMENT_VISUAL_KEY.NUMBER_ONE,
    hidden: true,
    sortOrder: 31,
  },
  {
    ...
    target: 10,
    visualKey: ACHIEVEMENT_VISUAL_KEY.HEADHUNTER,
    hidden: true,
    sortOrder: 32,
  },
  {
    ...
    target: 1,
    visualKey: ACHIEVEMENT_VISUAL_KEY.MARCO_REUS,
    hidden: true,
    sortOrder: 33,
  },
