...
const PLAYERS_SECTION = {
  ...
  items: [
    ...
    {
      href: "/admin/rating-eligibility",
      title: "Зачёт рейтинга",
      icon: (
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          <path d="M12 15a3 3 0 1 0 0-6 3 3 0 0 0 0 6z" />
          <path d="m8.5 12-2.5 8 6-4 6 4-2.5-8" />
        </svg>
      ),
    },
  ],
...
const STAFF_SECTION_SUPER_ADMIN = {
  title: "ПЕРСОНАЛ",
  items: [
    ...STAFF_SECTION.items,
    {
...
export default function AdminPage() {
  ...
  const sections = isSuperAdmin(player?.role) ? SUPER_ADMIN_SECTIONS : OPERATOR_SECTIONS;
